...
<!--ts-->
   ...
   * [Table of some Analog i/p voltages and corresponding Digital Code | DNL curve](#table-of-some-analog-i/p-voltages-and-corresponding-digital-code--dnl-curve)[here](/Documentation/DNL.pdf).
